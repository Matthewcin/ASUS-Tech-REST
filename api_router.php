...
$router->addRoute('computadoras/:id',     'PATCH',      'computadoraController',      'actualizarComputadora');
...
$router->addRoute('categorias/:id',  'PATCH',    'categoriasController',      'actualizarCategoria');
...
$router->addRoute('ofertas/:id',     'PATCH',      'ofertasController',      'actualizarOferta');
...
$router->addRoute('ofertas/:idOferta/computadoras/:idComputadora',     'PATCH',      'ofertasComputadorasController',      'actualizarComputadoraOferta');
